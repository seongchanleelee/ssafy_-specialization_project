...
import MobileRecommendation from "./MobileRecommendation";
import styles from "./MobileRecommendations.module.css"
import axios from "axios"
import { connect } from "react-redux";

function MobileRecommendations({counter}) {
    ...
    <div className={styles.recommendations}>
      <h2>WAYG가 추천해주는 여행지</h2>
        ...
        {recommendations.map((recommendation,idx) => (
          <MobileRecommendation parentFunction={parentFunction} {...recommendation} key={idx}/>
          ))}
          </div>
      <div ref={obsRef}>...</div>
    </div>
